...
sed -i "s/192.168.1/192.168.8/" package/feeds/kiddin9/base-files/files/bin/config_generate
sed -i "s/192.168.1/192.168.8/" package/base-files/files/bin/config_generate
