...
sed -i "s/192.168.8/10.0.0/" package/feeds/kiddin9/base-files/files/bin/config_generate
sed -i "s/192.168.8/10.0.0/" package/base-files/files/bin/config_generate
